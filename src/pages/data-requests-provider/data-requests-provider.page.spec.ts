...
describe('DataRequestsProviderPage - component behavior', () => {
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(DataRequestsProviderPage);
  ...
  it('should handle errors from dataRequestsResource and send them to errorService', async () => {
    ...
    const errorFixture = TestBed.createComponent(DataRequestsProviderPage);
  ...
  it('should navigate to request route when navigateToRequest is called with a valid request', () => {
    ...
    expect(mockRouter.navigate).toHaveBeenCalledWith([
      ROUTE_PATHS.DATA_REQUESTS_PROVIDER_PATH,
      'test-request-123',
    ]);
  });
