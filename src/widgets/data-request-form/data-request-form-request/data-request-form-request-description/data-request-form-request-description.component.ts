...
export class DataRequestFormRequestDescriptionComponent {
  ...
  protected readonly purposeSublabelParts = computed<PurposeSublabelParts>(() =>
    parsePurposeSublabel(this.i18nService.translate('data-request.form.request.purpose.sublabel')),
  );
}
