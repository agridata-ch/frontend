...
export class DataCatalogBlockComponent {
  ...
  protected readonly sortOptions = computed<SelectOption[]>(() => [
    { value: 'productName', label: this.i18nService.translate('dataCatalog.sort.nameAsc') },
    { value: '-productName', label: this.i18nService.translate('dataCatalog.sort.nameDesc') },
    { value: 'systemName', label: this.i18nService.translate('dataCatalog.sort.systemAsc') },
    {
      value: '-systemName',
      label: this.i18nService.translate('dataCatalog.sort.systemDesc'),
    },
    {
      value: 'providerName',
      label: this.i18nService.translate('dataCatalog.sort.providerAsc'),
    },
    {
      value: '-providerName',
      label: this.i18nService.translate('dataCatalog.sort.providerDesc'),
    },
  ]);
