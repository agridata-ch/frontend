...
export const APIS = [ConsentRequestsService, DataProductsService, DataRequestsService, InfoResourceService, ParticipantsService, TestDataService, UIDRegisterSearchService];
