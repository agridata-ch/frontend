...
export const APIS = [ConsentRequestsService, DataProductsService, DataProvidersService, DataRequestsService, DataTransferService, InfoResourceService, TestDataService, UIDRegisterSearchService, UsersService];
