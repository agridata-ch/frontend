...
export class DataProductsService extends BaseService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deleteDataProductDraft(id: string, actingRole?: 'PROVIDER' | 'ADMIN', observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public deleteDataProductDraft(id: string, actingRole?: 'PROVIDER' | 'ADMIN', observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public deleteDataProductDraft(id: string, actingRole?: 'PROVIDER' | 'ADMIN', observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public deleteDataProductDraft(id: string, actingRole?: 'PROVIDER' | 'ADMIN', observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deleteDataProductDraft.');
        }
     ...
     * Retrieves a paginated list of all available data products. Accessible to users with the producer, and admin. Supports pagination, sorting and column filtering on \&#39;dataSourceSystemId\&#39; and \&#39;dataProviderId\&#39;, e.g. filter&#x3D;dataProviderId:&lt;uuid&gt;,&lt;uuid&gt;;dataSourceSystemId:&lt;uuid&gt;.
     * @param filter 
     * @param language 
     * @param page 
     * @param searchTerm 
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getDataProductsPaginated(filter?: object, language?: string, page?: number, searchTerm?: string, size?: number, sortBy?: object, actingRole?: 'PROVIDER' | 'ADMIN', observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<PageResponseDtoDataProductDto>;
    ...
    public getDataProductsPaginated(filter?: object, language?: string, page?: number, searchTerm?: string, size?: number, sortBy?: object, actingRole?: 'PROVIDER' | 'ADMIN', observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
