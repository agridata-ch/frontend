...
4 API routes · 143 UI components · 218 library files · 18 middleware layers · 6 environment variables
...
**UI:** 143 components (angular) — see [ui.md](./ui.md)

**Libraries:** 218 files — see [libraries.md](./libraries.md)
